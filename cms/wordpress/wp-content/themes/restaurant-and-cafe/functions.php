...
if ( ! defined( 'RESTAURANT_AND_CAFE_THEME_VERSION' ) ) {
    ...
    define( 'RESTAURANT_AND_CAFE_THEME_NAME', $theme_data->get( 'Name' ) );
}
...
if( ! function_exists( 'restaurant_and_cafe_change_comment_form_default_fields' ) ) :
    ...
    function restaurant_and_cafe_change_comment_form_default_fields( $fields ){
        ...
        $fields['author'] = '<p class="comment-form-author"><label class="screen-reader-text" for="author">' . esc_html__( 'Name*', 'restaurant-and-cafe' ) . '</label><input id="author" name="author" placeholder="' . esc_attr__( 'Name*', 'restaurant-and-cafe' ) . '" type="text" value="' . esc_attr( $commenter['comment_author'] ) .
            '" size="30"' . $aria_req . ' /></p>';
        
        $fields['email'] = '<p class="comment-form-email"><label class="screen-reader-text" for="email">' . esc_html__( 'Email*', 'restaurant-and-cafe' ) . '</label><input id="email" name="email" placeholder="' . esc_attr__( 'Email*', 'restaurant-and-cafe' ) . '" type="text" value="' . esc_attr(  $commenter['comment_author_email'] ) .
            '" size="30"' . $aria_req . ' /></p>';
        
        $fields['url'] = '<p class="comment-form-url"><label class="screen-reader-text" for="url">' . esc_html__( 'Website', 'restaurant-and-cafe' ) . '</label><input id="url" name="url" placeholder="' . esc_attr__( 'Website', 'restaurant-and-cafe' ) . '" type="text" value="' . esc_attr( $commenter['comment_author_url'] ) .
            '" size="30" /></p>'; 
...
if( ! function_exists( 'restaurant_and_cafe_change_comment_form_defaults' ) ) :
	...
	*/
	function restaurant_and_cafe_change_comment_form_defaults( $defaults ){
	    ...
	    $defaults['comment_field'] = '<p class="comment-form-comment"><label class="screen-reader-text" for="comment">' . esc_html__( 'Comment', 'restaurant-and-cafe' ) . '</label><textarea id="comment" name="comment" placeholder="' . esc_attr__( 'Comment', 'restaurant-and-cafe' ) . '" cols="45" rows="8" aria-required="true">' .
	            '</textarea></p>';
